...
class AgendaController extends Controller
{
     ...
     *                      property="idResp",
     *                      type="integer",
     *                      description="ID usuario responsavel pela atividade."
     *                  ),
     *                 @OA\Property(
     *                      property="dtInicio",
     *                      type="string",
     ...
     *                      type="string",
     *                      description="Data de conclusao da atividade"
     *                  ),
     *                 @OA\Property(
     *                      property="status",
     *                      type="integer",
     *                      description="0 para nao finalizado - 1 para finalizado"
     *                  ),
     *                 @OA\Property(
     *                      property="titulo",
     *                      type="string",
     ...
     *                      property="created_at",
     *                      type="string",
     *                      description="Data de insercao do registro"
     *                  ),
     *                 @OA\Property(
     *                      property="updtaed_at",
     *                      type="string",
     *                      description="Data de modificacao do registro"
     *                  ),
     *              )
     *          )
     *      ),
