...
class AgendaTest extends TestCase
{
    public function testCriarEntradaAgenda()
    {
        $data = [
            ...
            'status'        => 0,
            'titulo'        => "Agenda 3",
            'descricao'     => "DescriÃ§Ã£o da agenda 3."
        ];
    ...
    public function testRotaDeletarRegistro()
    {
        ...
        $data = [
            ...
            'status'        => 0,
            'titulo'        => "Agenda 3",
            'descricao'     => "Nesta atividade, voce devera fazer a criacao de um card via integracao."
        ];
    ...
    public function testRotaEditarRegistro()
    {
        ...
        $data = [
            ...
            'status'        => 0,
            'titulo'        => "Agenda 3",
            'descricao'     => "Nesta atividade, vocÃª deverÃ¡ fazer a criacao de um card via integracao."
        ];
